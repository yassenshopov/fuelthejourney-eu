export default function AboutUsSection() {
  return (
    <section id="about" className="relative">
      ...
      <div className="bg-fuel-yellow px-16 py-16 md:px-32 lg:px-48 xl:px-64">
        <div className="max-w-5xl mx-auto">
          {/* First mini section */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-12">
            {/* Left side - Text */}
            <div className="order-2 lg:order-1">
              <p className="text-xl md:text-2xl lg:text-3xl leading-relaxed text-left text-fuel-black font-bebas font-bold uppercase">
            ...
            <div className="order-1 lg:order-2 flex justify-center lg:justify-end">
              <div className="w-48 h-128 md:w-86 md:h-128 bg-fuel-pink border-6 border-fuel-black rounded-lg shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]"></div>
            </div>
          </div>
