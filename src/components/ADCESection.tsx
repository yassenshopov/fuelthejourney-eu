export default function ADCESection() {
  return (
    <section id="adce" className="bg-fuel-yellow px-4 py-20 md:px-8">
      <div className="max-w-7xl mx-auto text-center">
        {/* Title */}
        <h2 className="font-bebas font-bold text-6xl md:text-8xl lg:text-9xl mb-12 text-fuel-black uppercase">
          Adc
          <span className="text-fuel-black text-2xl md:text-3xl lg:text-4xl align-text-top -mt-4 md:-mt-6 lg:-mt-8">
            ★
          </span>
          e
        </h2>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <p className="font-bebas font-bold text-lg md:text-xl lg:text-2xl leading-relaxed text-justify px-4 md:px-0 text-fuel-black uppercase">
            Брандове могат да &ldquo;купуват километри&rdquo; и така буквално да
            ни приближават до целта. Всеки изминат километър ще бъде отбелязван
            на интерактивна карта, а в края пътят до Барселона ще покаже всички,
